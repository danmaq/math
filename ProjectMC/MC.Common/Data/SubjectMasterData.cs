...
namespace MC.Common.Data
{
	...
	/// 教科マスタの単票データ。
	/// </summary>
	public struct SubjectMasterData : IEquatable<SubjectMasterData>
	{
		...
		public static implicit operator SubjectMasterData(int id) => new SubjectMasterData(id);
		...
		/// <returns>ID。</returns>
		public static implicit operator int(SubjectMasterData value) => value.SubjectId;
		...
		public override string ToString() =>
			StringHelper.CreateToString(
				className: nameof(SubjectMasterData),
				arguments:
		...
		/// <returns>値が等しい場合、true。</returns>
		public bool Equals(SubjectMasterData other) =>
