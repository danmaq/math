...
namespace MC.Core.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   プラクティスを開始します。 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string MESSAGE_PRACTICE_START {
            get {
                return ResourceManager.GetString("MESSAGE_PRACTICE_START", resourceCulture);
            }
        }
